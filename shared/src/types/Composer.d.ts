...
export type ComposerEvent = "composer-message" | "composer-events" | "composer-diagnostics" | "composer-error" | "composer-done" | "no-op";
...
export declare class ToolMessage extends BaseMessage {
    ...
    constructor(id: string, name: string, toolCallId: string, content: Record<string, unknown>, type: "start" | "end", metadata?: Record<string, unknown>);
}
export declare class AssistantMessage extends BaseMessage {
    content: string;
    constructor(id: string, input: string, inputTokens?: number, outputTokens?: number);
}
