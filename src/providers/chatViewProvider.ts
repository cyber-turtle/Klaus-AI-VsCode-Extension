...
export class ChatViewProvider implements vscode.WebviewViewProvider {
	public static readonly viewType = "klaus.chatview";
	public static readonly showComposerCommand = "klausai.opencomposer";
	...
	async updateSettingsOnUI() {
		if (this._webview) {
			this._webview.postMessage({
				command: "settings",
				value: await klausSettings.loadSettings(),
			});
		}
	}
	...
	private getHtmlForWebview(webview: vscode.Webview) {
		...
		const imageUri = getImageUri(webview, this._context, ["media", "klaus_logo.png"]);
