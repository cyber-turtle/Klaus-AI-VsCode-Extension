...
exports.createCommandExecuteTool = exports.commandExecuteSchema = void 0;
const tools_1 = require("@langchain/core/tools");
const zod_1 = require("zod");
const node_child_process_1 = require("node:child_process");
const schemas_1 = require("./schemas");
const messages_1 = require("@langchain/core/messages");
exports.commandExecuteSchema = schemas_1.baseToolSchema.extend({
    command: zod_1.z.string().describe("The command to execute in the terminal"),
});
 ...
 */
const createCommandExecuteTool = (workspace, envVariables, timeoutInMilliseconds = 60000) => {
    return (0, tools_1.tool)(async (input, config) => {
        return new Promise((resolve, reject) => {
            try {
                ...
                if (BLOCKED_COMMANDS.some((cmd) => {
                    ...
                    resolve(new messages_1.ToolMessage({
                        id: config.runId,
                ...
                let output = "";
                let hasExited = false;
                const terminalProcess = (0, node_child_process_1.spawn)(input.command, [], {
                    cwd: workspace,
                    shell: true,
                    env: {
                        ...process.env,
        ...
        schema: exports.commandExecuteSchema,
    });
};
exports.createCommandExecuteTool = createCommandExecuteTool;
//# sourceMappingURL=cmd_execute.js.map