...
exports.truncateChatHistory = exports.getContentWindow = void 0;
const getContentWindow = (document, position, window) => {
    let prefix = "";
    let suffix = "";
    const length = window;
    let tokenCount = 0;
...
const truncateChatHistory = (maxRecords, chatHistory) => {
...
exports.truncateChatHistory = truncateChatHistory;
//# sourceMappingURL=contentWindow.js.map