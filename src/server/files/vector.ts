...
export class VectorStore {
	...
	private summaryModel!: BaseChatModel | BaseLLM;
	private connect?: (
		uri: string,
	...
	constructor(
		...
		this.numDimensions = settings.embeddingSettings[settings.embeddingProvider]?.dimensions!;
	...
	async upsert(
		...
		try {
			const msg = buildSummarizationQuery(
				fileContents,
