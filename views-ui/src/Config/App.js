...
const InteractionSettingsConfig_1 = require("./InteractionSettingsConfig");
const vscode_1 = require("./utilities/vscode");
require("./App.css");
const AgentFeaturesView_1 = require("./AgentFeaturesView");
...
const App = () => {
    ...
    const [mcpTools, setMCPTools] = (0, react_1.useState)(new Map());
    (0, react_1.useEffect)(() => {
    ...
    const onInteractionSettingsChanged = (settings) => {
        setSettings((prevSettings) => ({
            ...prevSettings,
            interactionSettings: settings,
        }));
    };
    const onAiProviderChanged = (provider) => {
        setSettings((s) => ({
            ...s,
            aiProvider: provider,
        }));
    };
    const onEmbeddingAiProviderChanged = (provider) => {
        setSettings((s) => ({
            ...s,
            embeddingProvider: provider,
        }));
    };
    const onAiProviderSettingsChanged = (aiProviderSettings) => {
    ...
    const onEmbeddingAiProviderSettingsChanged = (aiProviderSettings) => {
    ...
    const onValidationSettingsChanged = (settings) => {
        setSettings((s) => ({
            ...s,
  ...
  `;
    return (<div className="flex flex-col p-6 max-w-7xl mx-auto">
			<div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
				<div>
					...
					<p className="text-[var(--vscode-descriptionForeground)]">
						...
						<a href="https://docs.getwingmanai.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">
							our documentation
						</a>{" "}
						...
						<div className="flex items-start gap-2">
							...
							<div>
								...
								<p className="text-gray-100 text-sm">
									...
									<a href="https://github.com/PatrickJS/awesome-cursorrules" target="_blank" rel="noopener noreferrer" className="text-white font-medium underline">
			...
			<div className="flex flex-col md:flex-row justify-end items-end md:items-center mb-8 gap-4">
				{saveStatus === "error" && (<div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 rounded-md shadow-sm">
				...
				<button type="button" onClick={() => saveSettings(settings)} disabled={saveStatus === "saving"} className={buttonClass}>
					{saveStatus === "saving" ? (<>
							{/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
				<section className={cardClass}>
					...
					<AiProvider_1.AiProvider settings={settings} onProviderChanged={onAiProviderChanged} onProviderSettingsChanged={onAiProviderSettingsChanged}/>
				</section>
				...
				<section className={cardClass}>
					...
					<InteractionSettingsConfig_1.InteractionSettingsConfig interactions={settings.interactionSettings} onChange={onInteractionSettingsChanged}/>
				</section>
				...
				<section className={cardClass}>
					...
					<AgentFeaturesView_1.AgentFeaturesView validationSettings={settings.agentSettings} onValidationChanged={onValidationSettingsChanged}/>
					<McpTools_1.MCPConfiguration mcpTools={mcpTools || []}/>
				</section>
				...
				<section className={`${cardClass} flex-2`}>
					...
					<EmbeddingProvider_1.EmbeddingProvider settings={settings} indexedFiles={indexedFiles} onProviderChanged={onEmbeddingAiProviderChanged} onProviderSettingsChanged={onEmbeddingAiProviderSettingsChanged}/>
				</section>
			</div>
		</div>);
};
