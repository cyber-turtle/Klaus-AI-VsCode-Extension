...
const tooltipInformation = {
	...
	automaticallyFixDiagnostics: "When enabled, Klaus will automatically fix import and linting errors in your code, improving code quality without manual intervention.",
